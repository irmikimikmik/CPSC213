...
int exec() {
  ...
  static const void* insOpCode_jump_table[14] = {&&L0, &&L1, &&L2, &&L3, &&L4, &&L6, &&L7, &&L8, &&L9, &&L10, &&L11, &&L12, &&L15, &&DEFAULT};
  static const void* insOp0_jump_table[10] = {&&K0, &&K1, &&K2, &&K3, &&K4, &&K5, &&K6, &&K7, &&K15, &&DEFAULT2};
  
  if (insOpCode < 0 || (12 < insOpCode && insOpCode < 15) || insOpCode == 5 || insOpCode > 15)
  {
      goto DEFAULT;
  }
  ...
  if (insOpCode < 5)
  {
      goto *insOpCode_jump_table[insOpCode];
  }

  if (5 < insOpCode && insOpCode <= 12)
  {
      goto *insOpCode_jump_table[insOpCode - 1];
  }
  
  if (insOpCode == 15)
  {
      goto *insOpCode_jump_table[12];
  }
...
L6:   // ALU ................... 6-sd
    if (insOp0 < 0 || (7 < insOp0 && insOp0 < 15) || 15 < insOp0)
    {
        goto DEFAULT2;
    }

    if (0 < insOp0 && insOp0 <= 7)
    {
        goto *insOp0_jump_table[insOp0];
    }

    if (insOp0 == 15)
    {
        goto *insOp0_jump_table[8];
    }
